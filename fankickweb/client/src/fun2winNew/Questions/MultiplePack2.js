...
import { Form, Icon, Input, Tooltip, Button, Checkbox, Col, Row, Radio,Popconfirm, message, Select } from 'antd';
        ...
        if (this.props.multiquestion === undefined) {
            return (
                <div className="removemultiForm">
                    <Row>
                        <Col span={5} xl={{span:2}} className="cfuntowinadd">
                            <h6 className='h6Fnt'>Select Answer</h6>
                        </Col>
                        <Col span={12} className="cfuntowinadd">
