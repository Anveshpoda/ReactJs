    ...
    if (this.props.pollquestion === undefined) {
      return (
        <div className="removepollForm">
          <Row>
            ...
            <Col span={1}>
              <span>
                {/* <Tooltip title=" Contest Question is required?">
              <Icon className="mrgnIconleft46" type="exclamation-circle-o" />
            </Tooltip> */}
      ...
      var packEdit = (!this.props.editable) ?
        ...
        (<div>
          ...
          <Row>
            <Col span={11} offset={13} className="cfuntowinQbtn">
              {/*    {this.state.pollbutton ? <Icon type="save" style={{ fontSize: '25px' }} id={"savePack" + a} className='createFun2Win' onClick={this.savePack.bind(this, a)} /> : null}
               {this.state.pollbutton ? <Button type="primary" id={"savePack" + a} className='createFun2Win' onClick={this.savePack.bind(this, a)}>Save</Button> : null} */}
            </Col>
          </Row>
          {editBtn}
        </div>
      ...
      return (<div >
        {/* {this.state.multibutton ? <Icon type="save" style={{ fontSize: '25px' }} id={"savePack" + a} className='createFun2Win' onClick={this.savePack.bind(this, a)} /> : null} */}
        <Row>
          <Col span={14}>
        ...
        {/*  {this.state.multibutton ? <Button type="primary" id={"savePack" + a} className='createFun2Win' onClick={this.savePack.bind(this, a)}>Save</Button> : null}*/}
        {/* <Button onClick={this.delete.bind(this, a)}>Delete</Button> */}
      </div>);
    }
  }
}
