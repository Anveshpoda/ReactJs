...
import $ from "jquery";
import { Form, Icon, Input, Tooltip, Button, Checkbox, Col, Row, Radio,Popconfirm, Upload, message, Select } from 'antd';
...
class GridPack2 extends React.Component {
    ...
    onChange89 = (e) => {
        // console.log("radio onchange 2", e)
    }
    onRadioChange = (e) => {
    ...
    onRadioChange1 = (e) => {
        // console.log("undefined form changing radio")
        const qType = e.target.value;
        this.setState({
            ...
            return (
                <div className="removegridForm">
                    ...
                    <Row>
                        ...
                        <Col span={6} offset={12} className="cfuntowinQbtn cfuntowinaddsbtns">
                        </Col>
                        <Col>
                ...
                (<div>
                    ...
                    <Row className="marginTop20">
                        <RadioGroup disabled={this.state.gridradioState} ref={RadioGroup => this.gridcorrectAnswer = RadioGroup}
                            ...
                            style={{ width: '100%' }}>
                            <Col span={5} className="marginuploadRight35">
                                <div className="cfunguploadimg">
                                    <Radio value={1}>  </Radio>
                                    <Upload {...props}
                                        className="avatar-uploader"
