...
import NotificationsListTablescheduled from './Scheduled/NotificationsListTablescheduled';
...
class ScheduledNotifications extends React.Component {
  constructor() {
    super();
    this.state = {
      role: ''
        ...
        <div>
          <Row>
            <Col span={24} className='MarginTop20'>
              <div className="SubMenuPushNotifications">
                <Col span={10}>
                  <h3 className="marginTop14 pageTitle">Scheduled Notifications</h3>
                </Col>
                <Col span={14}>
          ...
          <Row>
            <Col span={24} className=''>
              ...
              <NotificationsListTablescheduled role={this.state.role.scheduled}/>
            </Col>
          </Row>
        </div>
      </Dashboard>
