...
import { Form, Icon, Input, Button, Tooltip, Checkbox, Col, Row, Radio,Popconfirm, Upload, message } from 'antd';
        ...
        if (this.props.combinationquestion === undefined) {
            ...
            var packEdit = (!this.props.editable) ?
                ...
                (<div>
                    ...
                    <Row className="marginTop20">
                        <Col span={6}>
                            <Col span={24} className="marginRight441 fun2WinEditCombinationQuestion">
                        ...
                        <Col span={18}>
                            <RadioGroup disabled={this.state.combradioState}
                                ...
                                style={{ width: '100%' }}>
                                <Col span={8} className="marginRight440">
                                    <div className="fun2winuploadcombination">
                                        <Radio value={1}>  </Radio>
                                        <Upload {...props}
                                            className="avatar-uploader"
