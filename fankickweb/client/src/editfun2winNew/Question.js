...
class Question extends React.Component {
  ...
  componentWillReceiveProps(newProps){
    console.log("receive propvvvvvvvs",newProps.queueId);
    this.setState({
      category: newProps.questionCategory,queueId:newProps.queueId
    })
  }
  // componentWillUnmount(){
  //   console.log("this.state",this.state);
  // }
  //   handleQuestionsGrid(gridquestionType1){
  //   console.log("triiggered child throughh child",gridquestionType1)
  //   console.log("this.props in questions",this.props)
  //   var _self=this;
  //   //_self.props.onQuestionChange(gridquestionType1);
  //   // _self.props.fnGridAdd(gridquestionType1);
  //   _self.props.handleQuestionsGrid1(gridquestionType1);
  // }
  displayQuestion = () => {
  ...
  render() {
    console.log("this.props in questions", this.props);
    console.log("this.state in questions", this.state);
   // console.log("this.props.generatedkey",this.props.generatedkey);
    return (
