...
import { Col, Checkbox, Row, Form, Icon, Input, Button, Tag, Tooltip, InputNumber, Select, message, Upload, Tabs } from 'antd';
...
class CreateFun2WinNewPage extends React.Component {
  ...
  onDropDownChange = (key, e) => {
    // let substr = key.substring(key.indexOf("Q"), key.length)
    // console.log(this.state['mediaURL' + substr], "5545")
    // if(this.state['mediaURL'+substr] || this.state["mediaURL"+substr] === undefined){
    //   this.setState({
    //     [this.state['mediaURL'+substr]]: ''
    //   })
    // }
    // if(key) this.state.errors['mediaURL'+substr] = " "
          ...
          <Row className="">
            <Col span={24} xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 24 }} lg={{ span: 24 }} xl={{ span: 24 }} className='challengesmenu'>
              <div className="fun2winSubMenu redfun2winsubmenu">
                <Col span={2} sm={{span:4}} lg={{span:3}} xl={{span:2}}><h2 className="fun2winpageTitle">Create Fun2Win</h2></Col>
                        ...
                        <Col span={6}>
                          <FormItem label="Set Difficulty Type">
                            <Select
                              ...
                              filterOption={(input, option) => option.props.children.toLowerCase().indexOf(input.toLowerCase()) >= 0}
                              >
                              <Option value="EASY">Easy <span className="fun2wincreatetype"><Icon type="star" theme="filled"  className="fun2wineasy"/></span></Option>
                              <Option value="MEDIUM">Medium <span className="fun2wincreatetype"><Icon type="star" theme="filled" className="fun2winmedium"/></span></Option>
                              <Option value="HARD">Hard <span className="fun2wincreatetype"><Icon type="star" theme="filled" className="fun2winhard"/></span></Option>
                              <Option value="RAPID-FIRE">Rapid Fire <span className="fun2wincreatetype"><Icon type="star" theme="filled" className="fun2winrapidfire"/></span></Option>
                            </Select>
                      ...
                      <Col span={24} >
                        <Tabs className="QuestionTab"
                          ...
                          {this.state.panes.map((pane, index) => <TabPane tab={"Q." + (index + 1)} key={pane.key}>
                            <Row>
                              <Col span={24} className="Redfun2winQuestionType">
                                <Col xs={12} sm={12} xl={4} lg={5} md={4}>
                            ...
                            <Row>
                              {this.state["questionMediaType" + pane.key] ? (<div>
                                {this.state["questionMediaType" + pane.key] === 'image' ? (<div>
                                  ...
                                  <Row>
                                    <Questions questionCategory={'Image'} questionId={pane.key} saveSubQuestionPacks={this.saveSubQuestionPacks.bind(this)} />
                                  </Row>
                                </div>) : null}
                                {this.state["questionMediaType" + pane.key] === 'video' ? (<div>
                                    ...
                                    <Col span={24} className="Redfun2winquestionsmedas">
                                      <Col span={7}>
                                        <FormItem label="Enter Youtube Video URL">
                                          <Input name={"mediaURL" + pane.key} onChange={this.handleInputChange} />
                                        </FormItem>
                                        <p style={{ color: "red" }} className="Error">{this.state.errors['mediaURL' + pane.key]}</p>
                                      </Col>
                                      <Col span={2}>
                                      ...
                                      <Col span={14}>
                                        <FormItem label="Player start and End time">
                                          <InputNumber min={0} max={200000} onChange={this.onPlayerDurationChange.bind(this, "playerStartTime" + pane.key)} />  <span className="paddingLftRht15"> To  </span> <InputNumber min={0} max={200000} onChange={this.onPlayerDurationChange.bind(this, "playerStopTime" + pane.key)} />
                                  ...
                                  <Row>
                                    <Questions questionCategory={'Video'} questionId={pane.key} saveSubQuestionPacks={this.saveSubQuestionPacks.bind(this)} />
                                  </Row>
                                </div>) : null}
                                {this.state["questionMediaType" + pane.key] === 'audio' ? (<div>
                                  ...
                                  <Row>
                                    <Questions questionCategory={'Audio'} questionId={pane.key} saveSubQuestionPacks={this.saveSubQuestionPacks.bind(this)} />
                                  </Row>
                                </div>) : null}
                                {this.state["questionMediaType" + pane.key] === 'text' ? (<div className="Redfun2winquestionsmedas">

                                  <Row>
                                    <Questions questionCategory={'Text'} questionId={pane.key} saveSubQuestionPacks={this.saveSubQuestionPacks.bind(this)} />
                                  </Row>
                                </div>) : null}
                              </div>) : null}
                            </Row>
                    ...
                    <Form>
                      <Row>
                        <Col span={14} className="">
                          <FormItem>
                            <h6 className='h6Fnt'>Fun2Win Title    </h6>
                   ...
                   <Row>
                      ...
                      <Row>
                        <Col span={5} className="btnRight">
                          <Button type="primary" className='createFun2Win' onClick={this.saveContentPack.bind(this)}>Save Pack</Button>
                        </Col>
                      </Row>
                    </Form>
                  </TabPane>
...
export default CreateFun2WinNewPage;