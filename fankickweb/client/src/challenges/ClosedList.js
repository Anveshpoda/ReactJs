...
import { Menu, Row, Col, Card, Button, Dropdown, message, Spin, Icon, Modal } from 'antd';
...
class ClosedList extends React.Component {
  ...
  render() {
          ...
          <Card>
            ...
            <div>
              <ul className="list-inline messagecentcountul">
                <li className="ColorRed"><b>Closed</b></li>
              </ul>
            </div>
    ...
    if (currentTodos.length === 0) {
      return (
        <div>
          <div className="placeholderImages paddngLeft15">
            <Col span={6}><img src={Placeholder} alt="Placeholder" className="img-responsive" /></Col>
            <Col span={6}><img src={Placeholder} alt="Placeholder" className="img-responsive" /></Col>
            <Col span={6}><img src={Placeholder} alt="Placeholder" className="img-responsive" /></Col>
            <Col span={6}><img src={Placeholder} alt="Placeholder" className="img-responsive" /></Col>
            <Col span={6}><img src={Placeholder} alt="Placeholder" className="img-responsive" /></Col>
