...
import NewUpcomingElectionDashboard from './NewUpcomingElectionDashboard';
...
class PollUpComingElection extends React.Component {
    render() {
        return (
            <Dashboard>
                <div>
...
export default PollUpComingElection;
/* eslint-disable */