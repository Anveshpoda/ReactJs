...
import NewRunningElectionDashboard from './NewRunningElectionDashboard';
...
class PollRunningElection extends React.Component {
    render() {
        return (
            <Dashboard>
                <div>
...
export default PollRunningElection;
/* eslint-disable */