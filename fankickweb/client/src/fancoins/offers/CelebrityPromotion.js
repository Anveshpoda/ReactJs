            ...
            <div>
                ...
                <Col span={20}>
                    <Row>
                        <Col span={24}>
                            <Col span={12}>
                                <h3 className="HeadingsTab">Celebrity Promotion</h3>      </Col>
                            <Col span={12}>
                    ...
                    <div className="marginLeft30">
                        <Row className="marginBottom20">
                            <Col span={18}>
                                <Select showSearch
                                    placeholder="Select Celebrity Name"
                                    style={{ width: "100%" }}
                        ...
                        <Row>
                            ...
                            <Col span={24}>
                                <CheckboxGroup options={promtecheckBox} defaultValue={['']} onChange={onChange} />
                            </Col>
                        </Row>
