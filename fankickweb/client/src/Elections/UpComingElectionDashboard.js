...
import { Col, Button, Card, Dropdown, Icon, Popconfirm, Menu, message, Modal } from 'antd';
...
class UpComingElectionDashboard extends React.Component {
    static propTypes = {
    ...
    componentDidMount() {
        //console.log("upcoming called srvice")
        this.getContests();
    }
    getContests = () => {
        axios.get(process.env.REACT_APP_API_HOST + '/rest/optionPollsWeb', {
            ...
            .then(function (response) {
                ...
                for (let key in hhh) {
                    var keyObj = hhh[key];
                    if (new Date(keyObj.pollStartDateTime).getTime() > new Date().getTime()) {
                        contentPack.push(keyObj);
                    }
                }
                contentPack.sort(function (a, b) {
                    var key1 = a.pollStartDateTime;
    ...
    showModal = (e) => {
        ...
        axios.get(process.env.REACT_APP_API_HOST + '/rest/optionPollingById?pollId=' + id, {
            ...
            .then(function (response) {
                ...
                this.setState({ value: RichTextEditor.createValueFromString(response.data.data.termsAndConditions, 'html') });
    ...
    confirm = (e) => {
        var con = this;
        var id = sessionStorage.getItem('deletepollid');
        ...
        fetch(request)
            ...
            .then(function (response) {
                if (response.statusMessage === "Success") {
                    con.getContests();
                    var clear = sessionStorage.removeItem('deletepollid');
    ...
    deleteUser = (e) => {
        var id = e.target.id;
        //console.log("poll id in delete user", id);
        sessionStorage.setItem('deletepollid', id)
    }
    cancel = (e) => {
        //console.log(e);
    }
                    ...
                    <div>
                        <Col xs={12} sm={12} xl={4} lg={6} md={6}>
                            ...
                            <Card>
                                <div className="image">
                                    <figure>
                                        <img className="Boximage challengesmaincardImage" src={contest.pollImageUrl != '' ? contest.pollImageUrl : amitabh1} alt="Contest Cover" width='100%' max-width='400px' height='175px' />
                                    </figure>
                                ...
                                <div className="cardFooter">
                                    <ul className="list-inline">
                                        <li style={{ color: 'orange' }}><b>Upcoming</b></li>
                                            ...
                                            <Dropdown getPopupContainer={triggerNode => triggerNode.parentNode} overlay={<Menu>
                                                ...
                                                <Menu.Item key="0">
                                                    <Popconfirm title="Are you sure delete this task?" onConfirm={this.confirm} onCancel={this.cancel} okText="Yes" cancelText="No">
                                                        <a ><span id={contest.pollId} onClick={this.deleteUser.bind(this)}>Delete</span></a>
                                                    </Popconfirm>
                                                </Menu.Item>

                                                <Menu.Item key="1">
                                                    <Link to={`/ElectioMain/NewCreateElection/${contest.pollId}`} style={{ color: 'rgba(0, 0, 0, 0.65)' }}>Edit</Link>
                                                </Menu.Item>
                                                <Menu.Item key="2">
                                    ...
                                    <Col span={24}>
                                        ...
                                        <div className="Pollmatchsoptns">
                                            ...
                                            <Col span={6} className="ViewDatapollOptionss">
                                                <h4>Team 1</h4><p> {viewdata.option1 != undefined ? viewdata.option1.option : null}</p>
                                            </Col>
...
export default UpComingElectionDashboard;
/* eslint-disable */